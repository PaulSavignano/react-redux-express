  ...
  >
    <form
      onSubmit={handleSubmit((values) => {
        const path = `swipeable-style/${_id}`
        return dispatch(fetchUpdate(path, { values }))
      })}
    >
      <CardTitle title="Swipeable Style" />
      ...
      <div className="button-container">
        <SuccessableButton
          ...
          label="update swipeable"
          successLabel="swipeable updated!"
        />
      </div>
    </form>
  </Card>
...
export default reduxForm({ form: 'swipeableStyle' })(SwipeableStyleAdmin)
