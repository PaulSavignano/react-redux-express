...
const Footer = ({ muiTheme }) => {
  const { primary1Color, primary2Color } = muiTheme.palette
  return (
    <footer style={{ display: 'flex', justifyContent: 'center', padding: '60px 30px', backgroundColor: primary2Color, borderBottom: `50px solid ${primary1Color}` }}>
