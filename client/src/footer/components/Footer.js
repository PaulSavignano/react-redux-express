...
const Footer = ({ isFetching, brand, muiTheme }) => {
  const { primary1Color, primary2Color, primary3Color, textColor, fontFamily } = muiTheme.palette
  const {
    facebook,
    github,
    google,
  ...
  return (
    isFetching ? null :
    <footer style={{ backgroundColor: primary2Color, borderBottom: `50px solid ${primary1Color}`, marginTop: 128 }}>
